...
const typographyClass = {
  ...
  [TypographyVariant.BODY_1_B]: "text-sm leading-[1.2] font-semibold",
  [TypographyVariant.BODY_2]: "text-xs leading-[1.2] font-normal",
  [TypographyVariant.BODY_2_B]: "text-xs leading-[1.2] font-semibold",
  [TypographyVariant.DETAIL]: "text-[10px] leading-[1.2] font-normal",
  [TypographyVariant.DETAIL_B]: "text-[10px] leading-[1.2] font-semibold",
